...
/****************************************************************************
Function: get_string()
Description: Accepts user input for a string, makes sure the input doesnt fail.
Parameters: string &str
Pre-Conditions: takes string as parameter
Post-Conditions: string is good, my dude
***************************************************************************/
...
/****************************************************************************
Function: get_string()
Description: c-string version of get_string()
Parameters: char &str
Pre-Conditions: takes c-style string as parameter
Post-Conditions: string is good, my dude
***************************************************************************/
